...
| `CondCseq`            | 0x42a8b0[^merge] | 0x42a830[^merge] | 0x8002fa60   | game  | logic    | yes         |
| `CondCisne`           | 0x42a8e0         | 0x42a860         | 0x8002fa90   | game  | logic    | yes         |
| `CondCsne`            | 0x42a900         | 0x42a880         | 0x8002fab8   | game  | logic    | yes         |
| `CondCsseq`           | 0x42a8b0[^merge] | 0x42a830[^merge] | 0x8002fae8   | game  | logic    | yes         |
...
| `CondTisaz`           | 0x42aad0[^merge] | 0x42aa50[^merge] | 0x8002fcb0   | game  | logic    | yes         |
| `CondTismz`           | 0x42aad0[^merge] | 0x42aa50[^merge] | 0x8002fcd8   | game  | logic    | yes         |
| `CondCigeq`           | 0x42aaf0         | 0x42aa70         | 0x8002fd00   | game  | logic    | yes         |
| `CondCgeq`            | 0x42ab80[^merge] | 0x42aaa0[^merge] | 0x8002fd24   | game  | logic    | yes         |
| `CondCigne`           | 0x42ab20         | 0x42aad0         | 0x8002fd50   | game  | logic    | yes         |
| `CondCgne`            | 0x42ab50         | 0x42ab00         | 0x8002fd74   | game  | logic    | yes         |
| `CondCggeq`           | 0x42ab80[^merge] | 0x42aaa0[^merge] | 0x8002fda0   | game  | logic    | yes         |
...
| `CondTigaz`           | 0x42ad20[^merge] | 0x42aca0[^merge] | 0x8002fef0   | game  | logic    | yes         |
| `CondTigmz`           | 0x42ad20[^merge] | 0x42aca0[^merge] | 0x8002ff14   | game  | logic    | yes         |
...
| `ActionNop`           | 0x42d400[^merge] | 0x417010[^merge] | 0x80030f04   | game  | logic    | yes         |
